...
@interface MainSideViewController ()<UIGestureRecognizerDelegate>{
...
+ (MainSideViewController *)sharedSliderController
{
    static MainSideViewController *mianSideViewController;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        mianSideViewController = [[self alloc] init];
    });
    
    return mianSideViewController;
}
